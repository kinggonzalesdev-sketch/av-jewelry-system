          ...
          >
            <thead className="border-b text-[11px] uppercase tracking-wide text-muted-foreground">
              <tr>
                ...
                <th className="px-2.5 py-2 text-right font-medium">Total hours</th>
                <th className="px-2.5 py-2 font-medium">Status</th>
                <th className="px-2.5 py-2 text-right font-medium">Overtime</th>
                <th className="px-2.5 py-2 font-medium">Selfies</th>
                {canManage ? (
            ...
            <tbody>
              {filtered.map((r) => (
                <tr key={r.id} className="border-b last:border-0">
                  <td className="px-2.5 py-2 font-medium">{r.staffName ?? '—'}</td>
