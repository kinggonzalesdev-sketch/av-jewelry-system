    ...
    <>
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_320px]">
          ...
          <Card className="p-4">
            ...
            <div className="mt-3 space-y-2">
              ...
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                <p className="text-sm font-medium text-slate-700">Future channels</p>
            ...
            <ul className="mt-3 divide-y divide-slate-100 text-xs">
              {[
                ...
                <li key={role} className="flex items-start justify-between gap-3 py-2.5">
                  <span className="shrink-0 font-semibold text-slate-900">{role}</span>
                  <span className="text-right text-slate-600">{can}</span>
        ...
        <div className="space-y-4">
            ...
            <div className="mt-2 space-y-1">
              {STATES.map((s) => (
                <button
                  ...
                  type="button"
                  onClick={() => setState(s)}
                  className="flex w-full items-center justify-between gap-2 rounded-lg border border-slate-200 px-2.5 py-1.5 text-left text-[11px] text-slate-600 hover:bg-slate-50"
                >
                  {s}
          ...
          <Card className="p-4">
            <p className="text-xs font-medium text-slate-700">Manual fallback</p>
