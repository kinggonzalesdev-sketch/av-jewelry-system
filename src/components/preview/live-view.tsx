      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_340px]">
        <div className="space-y-4">
          ...
          <Card className="p-4">
            ...
            {batchOpen ? (
              <>
                <p className="mt-2 font-mono text-xs text-slate-500">LB-2026-000014</p>
                ...
                <div className="mt-3 rounded-lg border border-emerald-200 bg-emerald-50 p-3">
                  ...
                  <p className="mt-1 text-sm font-semibold text-slate-900">RG-18K-004</p>
            ...
            <ul className="mt-2 divide-y divide-slate-100 text-xs">
              {[
                ...
                <li key={ref} className="flex items-center justify-between gap-2 py-2">
                  <span className="font-mono text-slate-700">{ref}</span>
