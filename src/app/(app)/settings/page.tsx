...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Collapsed-by-default sections (progressive disclosure). System Diagnostics
          + Integration are PRIMARY-Super-Admin only. Live Operations + Message
          Templates show for ANY settings-viewer — so a non-owner the Owner grants
          settings access to (via Manage Access) sees exactly those two, while the
          Super Admin sees everything (Owner request 2026-08-09). */}
      {diagnostics ? (
        <SettingsSection
          icon="⌁"
