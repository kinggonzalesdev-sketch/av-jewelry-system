...
export function detectInventory(
  ...
  // Workbook-wide duplicate pass — ALL sheets/blocks together, every occurrence. Only the same
  // code is a duplicate; a number reused under another prefix is a different item (Owner 2026-09-26).
