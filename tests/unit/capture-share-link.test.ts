...
describe('first name (Private Reply greeting)', () => {
  // The AUTO TEXT message body itself is the configurable "Auto Sent Text Message" template — its
  // mode-aware rendering, computed totals, conditional Layaway DP and link-free guard live in
  // tests/unit/auto-text.test.ts. Here we only cover the first-name primitive this module still owns.
